...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessenger.SendMessageSync(customer.ToCustomerCreatedMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessenger.SendMessageSync(customer.ToCustomerUpdatedMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _sqsMessenger.SendMessageSync(new CustomerDeleted
            {
                Id = id
            });
        }
